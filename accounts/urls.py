...
urlpatterns = [
    ...
    path('logout/', views.LogoutView.as_view(
        ...
        next_page='/registration/login/'), name="logout"),
    ...
    path('password_reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(template_name='registration/password_reset_confirm.html',
